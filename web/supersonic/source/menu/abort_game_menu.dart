...
class AbortGameMenu extends Menu {
  ...
  void createChildren() {
    ...
    this.text_yes.defaultTextFormat =
        TextFormat(fontName, 48, 0, bold: true, align: TextFormatAlign.LEFT);
    ...
    this.text_no.defaultTextFormat =
        TextFormat(fontName, 48, 0, bold: true, align: TextFormatAlign.RIGHT);
