...
void main() {
  ...
  resourceManager.load().then((_) {
    ...
    html
        .querySelector('#song-happy-birthday')
        .onClick
        .listen((e) => karaoke.updateSong(happyBirthdayNotes, happyBirthdayLyrics));

    html
        .querySelector('#song-hey-jude')
        .onClick
        .listen((e) => karaoke.updateSong(heyJudeNotes, heyJudeLyrics));

    html
        .querySelector('#song-star-spangled-banner')
        .onClick
        .listen((e) => karaoke.updateSong(starSpangledBannerNotes, starSpangledBannerLyrics));

    html
        .querySelector('#song-you-are-my-sunshine')
        .onClick
        .listen((e) => karaoke.updateSong(youAreMySunshineNotes, youAreMySunshineLyrics));

    html.querySelector('#startOver').onClick.listen((e) => karaoke.resetSong());
  });
}
