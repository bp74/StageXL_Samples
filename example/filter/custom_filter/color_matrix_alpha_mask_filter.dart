...
class ColorMatrixAlphaMaskFilter extends BitmapFilter {
  ...
  final Float32List colorMatrixList = new Float32List(16);
  final Float32List colorOffsetList = new Float32List(4);
  ...
  @override
  BitmapFilter clone() => new ColorMatrixAlphaMaskFilter(bitmapData, matrix.clone());
  ...
  void renderFilter(RenderState renderState, RenderTextureQuad renderTextureQuad, int pass) {
    ...
    renderProgram  = renderContext.getRenderProgram(programName, () => new ColorMatrixAlphaMaskProgram());
